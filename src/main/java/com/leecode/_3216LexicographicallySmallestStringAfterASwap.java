...
public class _3216LexicographicallySmallestStringAfterASwap {
    ...
    public String getSmallestString(String s) {
        for (int i = 0; i < s.length() - 1; i++) {
            ...
            if (n % 2 == m % 2 && n > m) {
                s = s.replaceFirst(new String(new char[]{a,b}), new String(new char[]{b,a}));
                break;
            }
        }
        return s;
    ...
    public static void main(String[] args) {
        System.out.println(new _3216LexicographicallySmallestStringAfterASwap().getSmallestString("31"));
    }
}
